  ...
  return (
    <div className="w-full px-6 lg:px-10 mx-auto space-y-6 pb-12 h-full flex flex-col">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h1 className="text-2xl font-bold text-[#242424]">视觉生成</h1>
          <p className="text-sm text-[#6B6B6B] mt-1">专注于游戏角色的资产提取与场景重构</p>
        </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        <div className="w-full lg:w-1/3 flex flex-col space-y-6">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-[#E5E5E5] flex flex-col">
            <h3 className="text-base font-bold text-[#242424] mb-4">资产提取配置</h3>
            
            <div className="space-y-6 flex-1">
              <div>
                <label className="block text-sm font-medium text-[#242424] mb-2">上传单张游戏角色图片</label>
                <div className="border-2 border-dashed border-[#E5E5E5] rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-[rgba(0,0,0,0.04)] transition-colors cursor-pointer">
                  <div className="w-12 h-12 bg-[#F5F5F4] rounded-full flex items-center justify-center mb-3">
                    <Upload className="w-6 h-6 text-[#242424]" />
                  </div>
                  <p className="text-sm font-medium text-[#242424] mb-1">点击或拖拽图片至此</p>
                  <p className="text-xs text-[#6B6B6B]">支持 JPG, PNG, WEBP 格式，最大 10MB</p>
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-[#242424] mb-2">生成设置</label>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border border-[#E5E5E5] rounded-lg">
                    <span className="text-sm text-[#242424]">生成视角</span>
                    <span className="text-sm font-medium text-[#242424]">正面、侧面、背面、特写 (2x2)</span>
                  </div>
                  <div className="flex items-center justify-between p-3 border border-[#E5E5E5] rounded-lg">
                    <span className="text-sm text-[#242424]">背景处理</span>
                    <select className="text-sm font-medium text-[#242424] bg-transparent focus:outline-none">
            ...
            <button 
              ...
              className="w-full py-3 bg-[#242424] text-white rounded-lg text-sm font-medium hover:bg-black transition-colors disabled:opacity-50 flex items-center justify-center mt-6"
            >
              {isGenerating ? (
        ...
        <div className="w-full lg:w-2/3 bg-white rounded-xl shadow-sm border border-[#E5E5E5] flex flex-col relative overflow-hidden">
          <div className="p-4 border-b border-[#E5E5E5] flex items-center justify-between bg-[#FBFBFA]/50">
            <h3 className="text-base font-bold text-[#242424]">预览画布</h3>
          ...
          <div className="flex-1 p-8 overflow-y-auto bg-[#F8F9FA] flex items-center justify-center">
            {showResult ? (
              <div className="grid grid-cols-2 gap-4 w-full max-w-2xl">
                <div className="aspect-square bg-white rounded-xl border border-[#E5E5E5] overflow-hidden relative group">
